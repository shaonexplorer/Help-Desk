...
/**
 * Create-user page — a dispatch-board identity card on the warm-paper surface
 * shared with the crew roster. The monospace eyebrow and ink-blue accent tie
 * the two pages together without duplicating the roster's table layout.
 */
    ...
    <main className="crew flex-1 bg-[#F7F6F1] text-[#16150F]">
      <div className="mx-auto w-full max-w-2xl px-6 py-10">
        ...
        <p className="mb-8 max-w-lg text-2xl font-light leading-snug tracking-tight text-[#16150F]">
          Add a new station to the roster. They&rsquo;ll get an email to activate
